...
import Keymethods.GSTRegistration;
...
public class Leadcreation {
	...
	public void Login() throws InterruptedException, AWTException {
		...
		htmlReporter = new ExtentSparkReporter(
				"\\\\14.140.167.188\\Vakilsearch\\AutomatonLeadCreation5\\" + Date1 + "\\extentreport.html");
		// htmlReporter = new
	...
	GSTRegistration gstregistration = new GSTRegistration();
		...
		gstregistration.SoleProprietorship(driver, CrmUsernames, GRCMobileNumber, Date11, extentreport);
		gstregistration.PropertyType1(driver, CrmUsernames, GRCMobileNumber,Date11, extentreport);
		gstregistration.Property(driver, CrmUsernames, GRCMobileNumber,Date11, extentreport);
		base.Base1(driver, CrmUsernames, GRCMobileNumber, extentreport);
		gstregistration.GstRegistration(driver, Username, Mobilenumber,Date11,extentreport);
		gstregistration.SoleProprietorship(driver, CrmUsernames, GRCMobileNumber, Date11, extentreport);
		gstregistration.PropertyType2(driver, CrmUsernames, GRCMobileNumber, Date11, extentreport);
		gstregistration.Owned(driver, CrmUsernames, GRCMobileNumber, Date11, extentreport);
		base.Base1(driver, CrmUsernames, GRCMobileNumber, extentreport);
		gstregistration.GstRegistration(driver, Username, Mobilenumber,Date11,extentreport);
		gstregistration.SoleProprietorship(driver, CrmUsernames, GRCMobileNumber, Date11, extentreport);
		gstregistration.PropertyType3(driver, CrmUsernames, GRCMobileNumber,  Date11, extentreport);
		gstregistration.FamilyProperty(driver, CrmUsernames, GRCMobileNumber,  Date11, extentreport);
